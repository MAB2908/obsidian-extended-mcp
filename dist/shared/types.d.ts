...
export type ModelCapability = 'chat' | 'function-calling' | 'vision' | 'code-generation' | 'long-context' | 'reasoning' | 'embedding' | 'json-mode' | 'streaming';
