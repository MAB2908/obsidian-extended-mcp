export function createDevSystemTools(devSystem) {
    return [
        // ─── L1: Prompts ───
        {
        ...
        },
        {
            ...
            handler: async (args) => {
                const prompt = await devSystem.createPrompt(args);
        ...
        },
        {
            ...
            handler: async (args) => {
                ...
                const prompt = await devSystem.getPrompt(id);
                if (!prompt)
                    return { content: [{ type: 'text', text: 'Prompt not found' }], isError: true };
        ...
        },
        {
            ...
            handler: async (args) => {
                const skill = await devSystem.createSkill(args);
        ...
        },
        {
            ...
            handler: async (args) => {
                const agent = await devSystem.createAgent(args);
        ...
        },
        {
            ...
            handler: async (args) => {
                const workflow = await devSystem.createWorkflow(args);
...
//# sourceMappingURL=dev-system.js.map